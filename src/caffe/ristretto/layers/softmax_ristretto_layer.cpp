...
SoftmaxRistrettoLayer<Dtype>::SoftmaxRistrettoLayer(const LayerParameter& param)
      : SoftmaxLayer<Dtype>(param), BaseRistrettoLayer<Dtype>() 
{
...
template <typename Dtype>
void SoftmaxRistrettoLayer<Dtype>::Forward_cpu(const vector<Blob<Dtype>*>& bottom,
...
template <typename Dtype>
void SoftmaxRistrettoLayer<Dtype>::Forward_gpu(
	const vector<Blob<Dtype>*>& bottom, const vector<Blob<Dtype>*>& top) 
{
	return Forward_cpu(bottom, top);
}

INSTANTIATE_CLASS(SoftmaxRistrettoLayer);
REGISTER_LAYER_CLASS(SoftmaxRistretto);
